    ...
    <div class="receipt-main">
                ...
                <tr>
                    ...
                    <th class="grid-item grid-right">
                        <div class="pull-right receipt-section">
                            ...
                            <span class="text-large">Nº {{$alquiler->num_venta}}</span>
                        </div>
                    </th>
                </tr>
            </table>
                ...
                <tr>
                    <th class="grid-detalle">
                        <h5 class="receipt-detalle">
                            Fecha de Emisión &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                            <b class="datos">{{ date('d/m/Y H:i:s', strtotime($alquiler->fecha_grabacion)) }}</b>
                        </h5>
                        <h5 class="receipt-detalle">
                            R.U.C. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                            <b class="datos">{{ $grupo->ruc }}</b>
                        </h5>
                        <h5 class="receipt-detalle">
                            Nombre o Razón Social&nbsp;: <b class="datos">{{ $grupo->description }}</b>
                        </h5>
                        <h5 class="receipt-detalle">
                            Credito Bancario &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                        </h5>
                    ...
                    <th class="grid-detalle">
                        ...
                        <h5 class="receipt-detalle">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vencimiento&nbsp;:
                            <b class="datos">{{ date('d/m/Y', strtotime($alquiler->fecha_vencimiento)) }}</b>
                        </h5>
                        <h5 class="receipt-detalle">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Teléfono&nbsp;:
                        </h5>
        ...
        <div style="width:100%" class="container">
            <table style="width:100%">
                ...
                <tr>
                    <th class="border-titulo info datos" width="15%"> ALQMES{{$alquiler->num_cuota}}</th>
                    <th class="border-titulo info datos" width="29%">ALQUILER MES {{$alquiler->num_cuota}}</th>
                    <th class="border-titulo info datos" width="6%">{{number_format($alquiler->num_cuota, 2, ',', '.')}}</th>
                    <th class="border-titulo info datos" width="13%">{{number_format($alquiler->importe, 2, ',', '.')}}</th>
                    <th class="border-titulo info datos" width="11%">0,00</th>
                    <th class="border-titulo info datos" width="11%">0,00</th>
                    <th class="info datos" width="14%">{{number_format($alquiler->importe, 2, ',', '.')}}</th>
                </tr>
                <tr>
                    ...
                    <th width="10%" class="border-titulo subtotal-cantidad datos">0,00</th>
                    <th width="14%" class="subtotal-cantidad datos">{{number_format($alquiler->importe, 2, ',', '.')}}</th>
                </tr>
                <tr>

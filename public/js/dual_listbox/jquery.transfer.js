...
;(function($) {
    ...
    Transfer.prototype.left_group_items_search_handler = function() {
        ...
        $(self.groupItemSearcherId).on("keyup", function () {
            ...
            // var transferDoubleGroupListLiUlLis = self.$element.find(self.transferDoubleGroupListLiUlLiClass); //se comenta esta linea porque o sino el filtro lo realiza por servicio
            var transferDoubleGroupListLiUlLis = self.$element.find(self.transferDoubleGroupListLiClass);

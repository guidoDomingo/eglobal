  ...
  function json2html(json, options) {
    ...
    if (typeof json === 'string') {
      ...
      if (options.withLinks && isUrl(json)) {
        ...
        html += '<a class="json-string" style="cursor: pointer">' + json + '</a>';
      } else {
      ...
      if (json.length > 0) {
        ...
        for (var i = 0; i < json.length; ++i) {
          ...
          if (isCollapsable(json[i])) {
            ...
            html += '<a class="json-toggle" style="cursor: pointer"></a>';
          }
          ...
          for (var key in json) {
            if (Object.prototype.hasOwnProperty.call(json, key)) {
              ...
              if (isCollapsable(jsonElement)) {
                ...
                html += '<a class="json-toggle" style="cursor: pointer">' + keyRepr + '</a>';
              } else {
                html += keyRepr;
              }
  ...
  $.fn.jsonViewer = function(json, options) {
    ...
    return this.each(function() {
      ...
      if (options.rootCollapsable && isCollapsable(json)) {
        ...
        html = '<a class="json-toggle" style="cursor: pointer"></a>' + html;
      }
      ...
      $(this).on('click', 'a.json-toggle', function() {
        ...
        if (target.is(':visible')) {
          ...
          var placeholder = count + (count > 1 ? ' elementos' : ' elemento');
          //target.after('<a href class="json-placeholder">' + placeholder + '</a>');
          target.after('<a class="json-placeholder" style="cursor: pointer">' + placeholder + '</a>');
        }
        return false;
      });
